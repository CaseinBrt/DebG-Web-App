...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--name', type=str, default='/home/janadal/app/checkpoints/experiment_name', help='name of the experiment. It decides where to store samples and models')
		...
		self.parser.add_argument('--checkpoints_dir', type=str, default='/home/janadal/app/checkpoints', help='models are saved here')
